...
#args se usa para ingresar distintos tipos de elementos
class AVLTree():
    ...
    def delete(self, key):
        #borrando por apellido
        if self.node != None: 
            if self.node.lname == key: 
                ...
                #ve que nodo va a acomodar en el lugar del que se va a eliminar
                else:  
    ...
    def inorder_traverse(self):
        ...
        return inlist 
    #preguntar por este codigo de abajo
